...
__all__ = ['PhysicalReplicationSlotArgs', 'PhysicalReplicationSlot']
...
class PhysicalReplicationSlotArgs:
    def __init__(__self__, *,
        ...
        """
        PhysicalReplicationSlotArgs._configure(
...
@pulumi.input_type
class _PhysicalReplicationSlotState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] name: The name of the replication slot.
        """
        _PhysicalReplicationSlotState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            name=name,
        )
    @staticmethod
...
class PhysicalReplicationSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PhysicalReplicationSlotArgs, pulumi.ResourceOptions, *args, **kwargs)
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PhysicalReplicationSlotArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PhysicalReplicationSlotArgs.__new__(PhysicalReplicationSlotArgs)

            __props__.__dict__["name"] = name
        super(PhysicalReplicationSlot, __self__).__init__(
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'PhysicalReplicationSlot':
        """
        ...
        __props__ = _PhysicalReplicationSlotState.__new__(_PhysicalReplicationSlotState)

        __props__.__dict__["name"] = name
        return PhysicalReplicationSlot(resource_name, opts=opts, __props__=__props__)
