...
class DatabaseArgs:
    def __init__(__self__, *,
                 allow_connections: Optional[pulumi.Input[builtins.bool]] = None,
                 alter_object_ownership: Optional[pulumi.Input[builtins.bool]] = None,
                 connection_limit: Optional[pulumi.Input[builtins.int]] = None,
                 encoding: Optional[pulumi.Input[builtins.str]] = None,
                 is_template: Optional[pulumi.Input[builtins.bool]] = None,
                 lc_collate: Optional[pulumi.Input[builtins.str]] = None,
                 lc_ctype: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 owner: Optional[pulumi.Input[builtins.str]] = None,
                 tablespace_name: Optional[pulumi.Input[builtins.str]] = None,
                 template: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Database resource.
        :param pulumi.Input[builtins.bool] allow_connections: If `false` then no one can connect to this
               database. The default is `true`, allowing connections (except as restricted by
               other mechanisms, such as `GRANT` or `REVOKE CONNECT`).
        :param pulumi.Input[builtins.bool] alter_object_ownership: If `true`, the change of the database
        ...
        :param pulumi.Input[builtins.int] connection_limit: How many concurrent connections can be
               established to this database. `-1` (the default) means no limit.
        :param pulumi.Input[builtins.str] encoding: Character set encoding to use in the new database
        :param pulumi.Input[builtins.bool] is_template: If `true`, then this database can be cloned by any
               user with `CREATEDB` privileges; if `false` (the default), then only
               superusers or the owner of the database can clone it.
        :param pulumi.Input[builtins.str] lc_collate: Collation order (LC_COLLATE) to use in the new database
        :param pulumi.Input[builtins.str] lc_ctype: Character classification (LC_CTYPE) to use in the new database
        :param pulumi.Input[builtins.str] name: The name of the database. Must be unique on the PostgreSQL
               server instance where it is configured.
        :param pulumi.Input[builtins.str] owner: The role name of the user who will own the database, or
               `DEFAULT` to use the default (namely, the user executing the command). To
               create a database owned by another role or to change the owner of an existing
               database, you must be a direct or indirect member of the specified role, or
               the username in the provider is a superuser.
        :param pulumi.Input[builtins.str] tablespace_name: The name of the tablespace that will be
               associated with the database, or `DEFAULT` to use the template database's
               tablespace.  This tablespace will be the default tablespace used for objects
               created in this database.
        :param pulumi.Input[builtins.str] template: The name of the template from which to create the new database
        """
    ...
    def allow_connections(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_connections(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_connections", value)

    @property
    @pulumi.getter(name="alterObjectOwnership")
    def alter_object_ownership(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def alter_object_ownership(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_template(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_template.setter
    def is_template(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def tablespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tablespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Database(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner: Optional[pulumi.Input[builtins.str]] = None,
            tablespace_name: Optional[pulumi.Input[builtins.str]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None) -> 'Database':
        """
    ...
    @property
    @pulumi.getter(name="allowConnections")
    def allow_connections(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `false` then no one can connect to this
        database. The default is `true`, allowing connections (except as restricted by
        other mechanisms, such as `GRANT` or `REVOKE CONNECT`).
    ...
    @property
    @pulumi.getter(name="alterObjectOwnership")
    def alter_object_ownership(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true`, the change of the database
        `owner` will also include a reassignment of the ownership of preexisting
        objects like tables or sequences from the previous owner to the new one.
    ...
    @property
    @pulumi.getter(name="isTemplate")
    def is_template(self) -> pulumi.Output[builtins.bool]:
        """
        If `true`, then this database can be cloned by any
        user with `CREATEDB` privileges; if `false` (the default), then only
        superusers or the owner of the database can clone it.
    ...
    @property
    @pulumi.getter(name="tablespaceName")
    def tablespace_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the tablespace that will be
        associated with the database, or `DEFAULT` to use the template database's
        tablespace.  This tablespace will be the default tablespace used for objects
