...
class ServerArgs:
    def __init__(__self__, *,
                 fdw_name: pulumi.Input[builtins.str],
                 ...
                 server_owner: Optional[pulumi.Input[builtins.str]] = None,
                 server_type: Optional[pulumi.Input[builtins.str]] = None,
                 server_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Server resource.
        :param pulumi.Input[builtins.str] fdw_name: The name of the foreign-data wrapper that manages the server.
               Changing this value
               will force the creation of a new resource as this value can only be set
               when the foreign server is created.
        :param pulumi.Input[builtins.str] server_name: The name of the foreign server to be created.
        :param pulumi.Input[builtins.bool] drop_cascade: When true, will drop objects that depend on the server (such as user mappings), and in turn all objects that depend on those objects . (Default: false)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] options: This clause specifies the options for the server. The options typically define the connection details of the server, but the actual names and values are dependent on the server's foreign-data wrapper.
        :param pulumi.Input[builtins.str] server_owner: By default, the user who defines the server becomes its owner. Set this value to configure the new owner of the foreign server.
        :param pulumi.Input[builtins.str] server_type: Optional server type, potentially useful to foreign-data wrappers.
               Changing this value
               will force the creation of a new resource as this value can only be set
               when the foreign server is created.
        :param pulumi.Input[builtins.str] server_version: Optional server version, potentially useful to foreign-data wrappers.
        """
    ...
    def fdw_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @fdw_name.setter
    def fdw_name(self, value: pulumi.Input[builtins.str]):
    ...
    def server_owner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @server_owner.setter
    def server_owner(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServerState:
    def __init__(__self__, *,
                 drop_cascade: Optional[pulumi.Input[builtins.bool]] = None,
                 fdw_name: Optional[pulumi.Input[builtins.str]] = None,
                 options: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="fdwName")
    def fdw_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the foreign-data wrapper that manages the server.
        Changing this value
        will force the creation of a new resource as this value can only be set
    ...
    @fdw_name.setter
    def fdw_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fdw_name", value)
...
class Server(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server_owner: Optional[pulumi.Input[builtins.str]] = None,
            server_type: Optional[pulumi.Input[builtins.str]] = None,
            server_version: Optional[pulumi.Input[builtins.str]] = None) -> 'Server':
        """
    ...
    @property
    @pulumi.getter(name="fdwName")
    def fdw_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the foreign-data wrapper that manages the server.
        Changing this value
        will force the creation of a new resource as this value can only be set
    ...
    @property
    @pulumi.getter(name="serverOwner")
    def server_owner(self) -> pulumi.Output[builtins.str]:
        """
        By default, the user who defines the server becomes its owner. Set this value to configure the new owner of the foreign server.
        """
        return pulumi.get(self, "server_owner")
