...
class ExtensionArgs:
    def __init__(__self__, *,
                 create_cascade: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] create_cascade: When true, will also create any extensions that this extension depends on that are not already installed. (Default: false)
        :param pulumi.Input[builtins.str] database: Which database to create the extension on. Defaults to provider database.
        :param pulumi.Input[builtins.bool] drop_cascade: When true, will also drop all the objects that depend on the extension, and in turn all objects that depend on those objects. (Default: false)
        :param pulumi.Input[builtins.str] name: The name of the extension.
        :param pulumi.Input[builtins.str] schema: Sets the schema of an extension.
        :param pulumi.Input[builtins.str] version: Sets the version number of the extension.
        """
    ...
    def create_cascade(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def create_cascade(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("postgresql:index/extension:Extension")
class Extension(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="createCascade")
    def create_cascade(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, will also create any extensions that this extension depends on that are not already installed. (Default: false)
        """
        return pulumi.get(self, "create_cascade")
