...
class GetTablesResult:
    ...
    def table_types(self) -> Optional[Sequence[builtins.str]]:
...
def get_tables(database: Optional[builtins.str] = None,
               ...
               table_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str database: The PostgreSQL database which will be queried for table names.
    :param Sequence[builtins.str] like_all_patterns: List of expressions which will be pattern matched against table names in the query using the PostgreSQL ``LIKE ALL`` operators.
    :param Sequence[builtins.str] like_any_patterns: List of expressions which will be pattern matched against table names in the query using the PostgreSQL ``LIKE ANY`` operators.
    :param Sequence[builtins.str] not_like_all_patterns: List of expressions which will be pattern matched against table names in the query using the PostgreSQL ``NOT LIKE ALL`` operators.
    :param builtins.str regex_pattern: Expression which will be pattern matched against table names in the query using the PostgreSQL ``~`` (regular expression match) operator.
           
           Note that all optional arguments can be used in conjunction.
    :param Sequence[builtins.str] schemas: List of PostgreSQL schema(s) which will be queried for table names. Queries all schemas in the database by default.
    :param Sequence[builtins.str] table_types: List of PostgreSQL table types which will be queried for table names. Includes all table types by default (including views and temp tables). Use 'BASE TABLE' for normal tables only.
    """
    __args__ = dict()
...
def get_tables_output(database: Optional[pulumi.Input[builtins.str]] = None,
                      ...
                      schemas: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      table_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
