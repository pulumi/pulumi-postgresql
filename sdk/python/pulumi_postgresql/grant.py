...
class GrantArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] database: The database to grant privileges on for this role.
        :param pulumi.Input[builtins.str] object_type: The PostgreSQL object type to grant the privileges on (one of: database, schema, table, sequence, function, procedure, routine, foreign_data_wrapper, foreign_server, column).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] privileges: The list of privileges to grant. There are different kinds of privileges: SELECT, INSERT, UPDATE, DELETE, TRUNCATE, REFERENCES, TRIGGER, CREATE, CONNECT, TEMPORARY, EXECUTE, and USAGE. An empty list could be provided to revoke all privileges for this role.
        :param pulumi.Input[builtins.str] role: The name of the role to grant privileges on, Set it to "public" for all roles.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] columns: The columns upon which to grant the privileges. Required when `object_type` is `column`. You cannot specify this option if the `object_type` is not `column`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] objects: The objects upon which to grant the privileges. An empty list (the default) means to grant permissions on *all* objects of the specified type. You cannot specify this option if the `object_type` is `database` or `schema`. When `object_type` is `column`, only one value is allowed.
        :param pulumi.Input[builtins.str] schema: The database schema to grant privileges on for this role (Required except if object_type is "database")
        :param pulumi.Input[builtins.bool] with_grant_option: Whether the recipient of these privileges can grant the same privileges to others. Defaults to false.
        """
...
class Grant(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[builtins.str]] = None,
            schema: Optional[pulumi.Input[builtins.str]] = None,
            with_grant_option: Optional[pulumi.Input[builtins.bool]] = None) -> 'Grant':
        """
