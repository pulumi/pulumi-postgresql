...
class UserMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_name: The name of an existing server for which the user mapping is to be created.
               Changing this value
               will force the creation of a new resource as this value can only be set
               when the user mapping is created.
        :param pulumi.Input[builtins.str] user_name: The name of an existing user that is mapped to foreign server. CURRENT_ROLE, CURRENT_USER, and USER match the name of the current user. When PUBLIC is specified, a so-called public mapping is created that is used when no user-specific mapping is applicable.
               Changing this value
               will force the creation of a new resource as this value can only be set
               when the user mapping is created.
...
class UserMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            options: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            server_name: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'UserMapping':
        """
