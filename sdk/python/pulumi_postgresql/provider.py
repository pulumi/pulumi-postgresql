...
class ProviderArgs:
    def __init__(__self__, *,
                 aws_rds_iam_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 aws_rds_iam_profile: Optional[pulumi.Input[builtins.str]] = None,
                 aws_rds_iam_provider_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 aws_rds_iam_region: Optional[pulumi.Input[builtins.str]] = None,
                 azure_identity_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 database_username: Optional[pulumi.Input[builtins.str]] = None,
                 expected_version: Optional[pulumi.Input[builtins.str]] = None,
                 gcp_iam_impersonate_service_account: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 sslrootcert: Optional[pulumi.Input[builtins.str]] = None,
                 superuser: Optional[pulumi.Input[builtins.bool]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.bool] aws_rds_iam_auth: Use rds_iam instead of password authentication (see:
               https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.html)
        :param pulumi.Input[builtins.str] aws_rds_iam_profile: AWS profile to use for IAM auth
        :param pulumi.Input[builtins.str] aws_rds_iam_provider_role_arn: AWS IAM role to assume for IAM auth
        :param pulumi.Input[builtins.str] aws_rds_iam_region: AWS region to use for IAM auth
        :param pulumi.Input[builtins.bool] azure_identity_auth: Use MS Azure identity OAuth token (see:
        ...
        :param pulumi.Input[builtins.int] connect_timeout: Maximum wait for connection, in seconds. Zero or not specified means wait indefinitely.
        :param pulumi.Input[builtins.str] database: The name of the database to connect to in order to conenct to (defaults to `postgres`).
        :param pulumi.Input[builtins.str] database_username: Database username associated to the connected user (for user name maps)
        :param pulumi.Input[builtins.str] expected_version: Specify the expected version of PostgreSQL.
        :param pulumi.Input[builtins.str] gcp_iam_impersonate_service_account: Service account to impersonate when using GCP IAM authentication.
        :param pulumi.Input[builtins.str] host: Name of PostgreSQL server address to connect to
        :param pulumi.Input[builtins.int] max_connections: Maximum number of connections to establish to the database. Zero means unlimited.
        :param pulumi.Input[builtins.str] password: Password to be used if the PostgreSQL server demands password authentication
        :param pulumi.Input[builtins.int] port: The PostgreSQL port number to connect to at the server host, or socket file name extension for Unix-domain connections
        :param pulumi.Input[builtins.str] sslmode: This option determines whether or with what priority a secure SSL TCP/IP connection will be negotiated with the
               PostgreSQL server
        :param pulumi.Input[builtins.str] sslrootcert: The SSL server root certificate file path. The file must contain PEM encoded data.
        :param pulumi.Input[builtins.bool] superuser: Specify if the user to connect as is a Postgres superuser or not.If not, some feature might be disabled (e.g.:
               Refreshing state password from Postgres)
        :param pulumi.Input[builtins.str] username: PostgreSQL user name to connect as
        """
    ...
    def aws_rds_iam_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def aws_rds_iam_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "aws_rds_iam_auth", value)

    @property
    @pulumi.getter(name="awsRdsIamProfile")
    def aws_rds_iam_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aws_rds_iam_profile(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aws_rds_iam_profile", value)

    @property
    @pulumi.getter(name="awsRdsIamProviderRoleArn")
    def aws_rds_iam_provider_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aws_rds_iam_provider_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aws_rds_iam_provider_role_arn", value)

    @property
    @pulumi.getter(name="awsRdsIamRegion")
    def aws_rds_iam_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aws_rds_iam_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aws_rds_iam_region", value)

    @property
    @pulumi.getter(name="azureIdentityAuth")
    def azure_identity_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def azure_identity_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def database_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_username(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_username", value)

    @property
    @pulumi.getter(name="expectedVersion")
    def expected_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def expected_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "expected_version", value)

    @property
    @pulumi.getter(name="gcpIamImpersonateServiceAccount")
    def gcp_iam_impersonate_service_account(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gcp_iam_impersonate_service_account(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def sslrootcert(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sslrootcert.setter
    def sslrootcert(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("pulumi:providers:postgresql")
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="awsRdsIamProfile")
    def aws_rds_iam_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        AWS profile to use for IAM auth
        """
        return pulumi.get(self, "aws_rds_iam_profile")
    ...
    @property
    @pulumi.getter(name="awsRdsIamProviderRoleArn")
    def aws_rds_iam_provider_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        AWS IAM role to assume for IAM auth
        """
        return pulumi.get(self, "aws_rds_iam_provider_role_arn")
    ...
    @property
    @pulumi.getter(name="awsRdsIamRegion")
    def aws_rds_iam_region(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        AWS region to use for IAM auth
        """
        return pulumi.get(self, "aws_rds_iam_region")
    ...
    @property
    @pulumi.getter(name="databaseUsername")
    def database_username(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Database username associated to the connected user (for user name maps)
        """
        return pulumi.get(self, "database_username")
    ...
    @property
    @pulumi.getter(name="expectedVersion")
    def expected_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify the expected version of PostgreSQL.
        """
        return pulumi.get(self, "expected_version")
    ...
    @property
    @pulumi.getter(name="gcpIamImpersonateServiceAccount")
    def gcp_iam_impersonate_service_account(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Service account to impersonate when using GCP IAM authentication.
        """
        return pulumi.get(self, "gcp_iam_impersonate_service_account")
    ...
    @property
    @pulumi.getter
    def sslrootcert(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SSL server root certificate file path. The file must contain PEM encoded data.
        """
        return pulumi.get(self, "sslrootcert")
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:postgresql/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult)
