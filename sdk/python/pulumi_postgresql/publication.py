...
class PublicationArgs:
    def __init__(__self__, *,
                 all_tables: Optional[pulumi.Input[builtins.bool]] = None,
                 database: Optional[pulumi.Input[builtins.str]] = None,
                 drop_cascade: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 owner: Optional[pulumi.Input[builtins.str]] = None,
                 publish_params: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 publish_via_partition_root_param: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] all_tables: Should be ALL TABLES added to the publication. Defaults to 'false'
        :param pulumi.Input[builtins.str] database: Which database to create the publication on. Defaults to provider database.
        :param pulumi.Input[builtins.bool] drop_cascade: Should all subsequent resources of the publication be dropped. Defaults to 'false'
        :param pulumi.Input[builtins.str] name: The name of the publication.
        :param pulumi.Input[builtins.str] owner: Who owns the publication. Defaults to provider user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] publish_params: Which 'publish' options should be turned on. Default to 'insert','update','delete'
        :param pulumi.Input[builtins.bool] publish_via_partition_root_param: Should be option 'publish_via_partition_root' be turned on. Default to 'false'
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tables: Which tables add to the publication. By defaults no tables added. Format of table is `<schema_name>.<table_name>`. If `<schema_name>` is not specified - default database schema will be used.  Table string must be listed in alphabetical order.
        """
    ...
    def all_tables(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @all_tables.setter
    def all_tables(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def publish_params(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def publish_params(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "publish_params", value)

    @property
    @pulumi.getter(name="publishViaPartitionRootParam")
    def publish_via_partition_root_param(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def publish_via_partition_root_param(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Publication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            publish_params: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            publish_via_partition_root_param: Optional[pulumi.Input[builtins.bool]] = None,
            tables: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Publication':
        """
    ...
    @property
    @pulumi.getter(name="allTables")
    def all_tables(self) -> pulumi.Output[builtins.bool]:
        """
        Should be ALL TABLES added to the publication. Defaults to 'false'
        """
        return pulumi.get(self, "all_tables")
    ...
    @property
    @pulumi.getter(name="publishParams")
    def publish_params(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Which 'publish' options should be turned on. Default to 'insert','update','delete'
        """
        return pulumi.get(self, "publish_params")
    ...
    @property
    @pulumi.getter(name="publishViaPartitionRootParam")
    def publish_via_partition_root_param(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should be option 'publish_via_partition_root' be turned on. Default to 'false'
        """
        return pulumi.get(self, "publish_via_partition_root_param")
    ...
    @property
    @pulumi.getter
    def tables(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Which tables add to the publication. By defaults no tables added. Format of table is `<schema_name>.<table_name>`. If `<schema_name>` is not specified - default database schema will be used.  Table string must be listed in alphabetical order.
        """
        return pulumi.get(self, "tables")
