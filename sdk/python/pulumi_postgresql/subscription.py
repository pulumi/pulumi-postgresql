...
class SubscriptionArgs:
    def __init__(__self__, *,
                 conninfo: pulumi.Input[builtins.str],
                 publications: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 create_slot: Optional[pulumi.Input[builtins.bool]] = None,
                 database: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 slot_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Subscription resource.
        :param pulumi.Input[builtins.str] conninfo: The connection string to the publisher. It should follow the [keyword/value format](https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-CONNSTRING)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] publications: Names of the publications on the publisher to subscribe to
        :param pulumi.Input[builtins.bool] create_slot: Specifies whether the command should create the replication slot on the publisher. Default behavior is true
        :param pulumi.Input[builtins.str] database: Which database to create the subscription on. Defaults to provider database.
        :param pulumi.Input[builtins.str] name: The name of the publication.
        :param pulumi.Input[builtins.str] slot_name: Name of the replication slot to use. The default behavior is to use the name of the subscription for the slot name
        """
    ...
    @property
    @pulumi.getter
    def conninfo(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @conninfo.setter
    def conninfo(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "conninfo", value)

    @property
    @pulumi.getter
    def publications(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @publications.setter
    def publications(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "publications", value)

    @property
    @pulumi.getter(name="createSlot")
    def create_slot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @create_slot.setter
    def create_slot(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SubscriptionState:
    def __init__(__self__, *,
                 conninfo: Optional[pulumi.Input[builtins.str]] = None,
                 create_slot: Optional[pulumi.Input[builtins.bool]] = None,
                 database: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 publications: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 slot_name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter
    def conninfo(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The connection string to the publisher. It should follow the [keyword/value format](https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-CONNSTRING)
        """
        return pulumi.get(self, "conninfo")
    ...
    @conninfo.setter
    def conninfo(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "conninfo", value)
    ...
    @property
    @pulumi.getter
    def publications(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Names of the publications on the publisher to subscribe to
        """
        return pulumi.get(self, "publications")
    ...
    @publications.setter
    def publications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "publications", value)
...
class Subscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            publications: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            slot_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Subscription':
        """
    ...
    @property
    @pulumi.getter
    def conninfo(self) -> pulumi.Output[builtins.str]:
        """
        The connection string to the publisher. It should follow the [keyword/value format](https://www.postgresql.org/docs/current/libpq-connect.html#LIBPQ-CONNSTRING)
        """
        return pulumi.get(self, "conninfo")
    ...
    @property
    @pulumi.getter(name="createSlot")
    def create_slot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the command should create the replication slot on the publisher. Default behavior is true
        """
        return pulumi.get(self, "create_slot")
    ...
    @property
    @pulumi.getter
    def publications(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Names of the publications on the publisher to subscribe to
        """
        return pulumi.get(self, "publications")
    ...
    @property
    @pulumi.getter(name="slotName")
    def slot_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the replication slot to use. The default behavior is to use the name of the subscription for the slot name
        """
        return pulumi.get(self, "slot_name")
