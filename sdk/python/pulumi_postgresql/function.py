...
class FunctionArgs:
    def __init__(__self__, *,
                 ...
                 drop_cascade: Optional[pulumi.Input[builtins.bool]] = None,
                 language: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parallel: Optional[pulumi.Input[builtins.str]] = None,
                 returns: Optional[pulumi.Input[builtins.str]] = None,
                 schema: Optional[pulumi.Input[builtins.str]] = None,
                 security_definer: Optional[pulumi.Input[builtins.bool]] = None,
                 strict: Optional[pulumi.Input[builtins.bool]] = None,
                 volatility: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Function resource.
        :param pulumi.Input[builtins.str] body: Function body.
        ...
        :param pulumi.Input[builtins.str] database: The database where the function is located.
               If not specified, the function is created in the current database.
        :param pulumi.Input[builtins.bool] drop_cascade: True to automatically drop objects that depend on the function (such as
               operators or triggers), and in turn all objects that depend on those objects. Default is false.
        :param pulumi.Input[builtins.str] language: The function programming language. Can be one of internal, sql, c, plpgsql. Default is plpgsql.
        :param pulumi.Input[builtins.str] name: The name of the function.
        :param pulumi.Input[builtins.str] parallel: Indicates if the function is parallel safe. Can be one of UNSAFE, RESTRICTED, or SAFE. Default is UNSAFE.
        :param pulumi.Input[builtins.str] returns: Type that the function returns. It can be computed from the OUT arguments. Default is void.
        :param pulumi.Input[builtins.str] schema: The schema where the function is located.
               If not specified, the function is created in the current schema.
        :param pulumi.Input[builtins.bool] security_definer: If the function should execute with the permissions of the owner, rather than the permissions of the caller. Default is false.
        :param pulumi.Input[builtins.bool] strict: If the function should always return NULL when any of the inputs is NULL. Default is false.
        :param pulumi.Input[builtins.str] volatility: Defines the volatility of the function. Can be one of VOLATILE, STABLE, or IMMUTABLE. Default is VOLATILE.
        """
    ...
    def drop_cascade(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @drop_cascade.setter
    def drop_cascade(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def parallel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @parallel.setter
    def parallel(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parallel", value)

    @property
    @pulumi.getter
    def returns(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @returns.setter
    def returns(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_definer(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def security_definer(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "security_definer", value)

    @property
    @pulumi.getter
    def strict(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @strict.setter
    def strict(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "strict", value)

    @property
    @pulumi.getter
    def volatility(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @volatility.setter
    def volatility(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Function(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            security_definer: Optional[pulumi.Input[builtins.bool]] = None,
            strict: Optional[pulumi.Input[builtins.bool]] = None,
            volatility: Optional[pulumi.Input[builtins.str]] = None) -> 'Function':
        """
    ...
    @property
    @pulumi.getter(name="dropCascade")
    def drop_cascade(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        True to automatically drop objects that depend on the function (such as
        operators or triggers), and in turn all objects that depend on those objects. Default is false.
        """
    ...
    @property
    @pulumi.getter
    def parallel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates if the function is parallel safe. Can be one of UNSAFE, RESTRICTED, or SAFE. Default is UNSAFE.
        """
        return pulumi.get(self, "parallel")
    ...
    @property
    @pulumi.getter
    def returns(self) -> pulumi.Output[builtins.str]:
        """
        Type that the function returns. It can be computed from the OUT arguments. Default is void.
        """
        return pulumi.get(self, "returns")
    ...
    @property
    @pulumi.getter(name="securityDefiner")
    def security_definer(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the function should execute with the permissions of the owner, rather than the permissions of the caller. Default is false.
        """
        return pulumi.get(self, "security_definer")
    ...
    @property
    @pulumi.getter
    def strict(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If the function should always return NULL when any of the inputs is NULL. Default is false.
        """
        return pulumi.get(self, "strict")
    ...
    @property
    @pulumi.getter
    def volatility(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defines the volatility of the function. Can be one of VOLATILE, STABLE, or IMMUTABLE. Default is VOLATILE.
        """
        return pulumi.get(self, "volatility")
