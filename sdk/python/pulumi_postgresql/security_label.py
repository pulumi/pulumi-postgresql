...
class SecurityLabelArgs:
    def __init__(__self__, *,
                 ...
                 label_provider: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] object_type: The PostgreSQL object type to apply this security label to.
        """
    ...
    def label_provider(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def label_provider(self, value: pulumi.Input[_builtins.str]):
...
class SecurityLabel(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="labelProvider")
    def label_provider(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the provider with which this label is to be associated.
        """
        return pulumi.get(self, "label_provider")
