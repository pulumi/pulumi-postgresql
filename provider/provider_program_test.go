...
func TestPrograms(t *testing.T) {
	programs := []string{
		...
		"test-programs/index_defaultprivileges",
		"test-programs/index_schema",
		"test-programs/index_extension",
		"test-programs/index_grantrole",
		"test-programs/index_function",
		"test-programs/index_publication",
		"test-programs/index_defaultprivileg",
		"test-programs/index_replicationslot",
	}
